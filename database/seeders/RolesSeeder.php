...
class RolesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $roleEmpleado = Role::create(['name' => 'empleado', 'guard_name' => 'admin']);
        ...
        // Empleado
        Permission::create(['name' => 'empleado.sidebar.dashboard', 'description' => 'Sidebar dashboard para empleado'])->syncRoles($roleEmpleado);
    }
}
