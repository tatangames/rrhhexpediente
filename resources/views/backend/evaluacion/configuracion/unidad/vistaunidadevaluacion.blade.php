...
@section('js')
    ...
    <script>
        $(function () {
            const ruta = "{{ url('/admin/unidad-evaluacion/tabla') }}";
    ...
    <script>
        ...
        function recargar() {
            var ruta = "{{ url('/admin/unidad-evaluacion/tabla') }}";
        ...
        function nuevo() {
            ...
            axios.post(urlAdmin + '/admin/unidad-evaluacion/nuevo', formData, {})
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id) {
            ...
            axios.post(urlAdmin + '/admin/unidad-evaluacion/informacion', {
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar() {
            ...
            axios.post(urlAdmin + '/admin/unidad-evaluacion/editar', formData, {})
                .then((response) => {
                    closeLoading();
        ...
        function borrarRegistro(id){
            ...
            axios.post(urlAdmin + '/admin/unidad-evaluacion/borrar', formData)
                .then((response) => {
                    closeLoading();
