...
@section('js')
    ...
    <script>
        $(function () {
            const ruta = "{{ url('/admin/cargo-evaluacion/tabla') }}";
    ...
    <script>
        ...
        function recargar() {
            var ruta = "{{ url('/admin/cargo-evaluacion/tabla') }}";
        ...
        function nuevo() {
            ...
            axios.post(urlAdmin + '/admin/cargo-evaluacion/nuevo', formData, {})
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id) {
            ...
            axios.post(urlAdmin + '/admin/cargo-evaluacion/informacion', {
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar() {
            ...
            axios.post(urlAdmin + '/admin/cargo-evaluacion/editar', formData, {})
                .then((response) => {
                    closeLoading();
        ...
        function borrarRegistro(id){
            ...
            axios.post(urlAdmin + '/admin/cargo-evaluacion/borrar', formData)
                .then((response) => {
                    closeLoading();
