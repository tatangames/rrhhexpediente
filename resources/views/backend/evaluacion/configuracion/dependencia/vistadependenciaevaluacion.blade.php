...
@section('title', 'Dependencia Jerarquica')

@section('content_header')
    <h1>Dependencia Jerarquica</h1>
@stop
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Dependencia</li>
                    <li class="breadcrumb-item active">Listado de Dependencia</li>
                </ol>
            </div>
        </div>
    </section>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="100" class="form-control" id="dependencia-nuevo"
                                               autocomplete="off">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Nombre Dependencia</label>
                                        <input type="text" maxlength="100" class="form-control" id="dependencia-editar"
                                               autocomplete="off">
                                    </div>
...
@section('js')
    ...
    <script>
        $(function () {
            const ruta = "{{ url('/admin/dependencia-evaluacion/tabla') }}";
    ...
    <script>
        ...
        function recargar() {
            var ruta = "{{ url('/admin/dependencia-evaluacion/tabla') }}";
        ...
        function nuevo() {
            var nombre = document.getElementById('dependencia-nuevo').value;
            ...
            axios.post(urlAdmin + '/admin/dependencia-evaluacion/nuevo', formData, {})
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id) {
            ...
            axios.post(urlAdmin + '/admin/dependencia-evaluacion/informacion', {
                'id': id
            })
                .then((response) => {
                    closeLoading();
                    if (response.data.success === 1) {
                        ...
                        $('#id-editar').val(id);
                        $('#dependencia-editar').val(response.data.info.nombre);
        ...
        function editar() {
            ...
            var nombre = document.getElementById('dependencia-editar').value;
            ...
            axios.post(urlAdmin + '/admin/dependencia-evaluacion/editar', formData, {})
                .then((response) => {
                    closeLoading();
        ...
        function borrarRegistro(id){
            ...
            axios.post(urlAdmin + '/admin/dependencia-evaluacion/borrar', formData)
                .then((response) => {
                    closeLoading();
