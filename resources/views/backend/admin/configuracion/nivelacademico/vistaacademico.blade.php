        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Nivel</li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="100" class="form-control" id="nivel-nuevo"
                                               autocomplete="off">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Nivel Académico</label>
                                        <input type="text" maxlength="100" class="form-control" id="nivel-editar"
                                               autocomplete="off">
                                    </div>
...
@section('js')
    ...
    <script>
        $(function () {
            const ruta = "{{ url('/admin/nivelacademico/tabla') }}";
    ...
    <script>
        ...
        function recargar() {
            var ruta = "{{ url('/admin/nivelacademico/tabla') }}";
        ...
        function nuevo() {
            var nombre = document.getElementById('nivel-nuevo').value;
            ...
            axios.post(urlAdmin + '/admin/nivelacademico/nuevo', formData, {})
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id) {
            ...
            axios.post(urlAdmin + '/admin/nivelacademico/informacion', {
                'id': id
            })
                .then((response) => {
                    closeLoading();
                    if (response.data.success === 1) {
                        ...
                        $('#id-editar').val(id);
                        $('#nivel-editar').val(response.data.info.nombre);
        ...
        function editar() {
            ...
            var nombre = document.getElementById('nivel-editar').value;
            ...
            axios.post(urlAdmin + '/admin/nivelacademico/editar', formData, {})
                .then((response) => {
                    closeLoading();
