...
@section('title', 'Tipo de Permisos')
...
@section('content')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Tipo de Permiso</li>
                    <li class="breadcrumb-item active">Listado de Tipo de Permiso</li>
                </ol>
            </div>
        </div>
    </section>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="100" class="form-control" id="tipopermiso-nuevo"
                                               autocomplete="off">
                                    </div>
    ...
    <div class="modal fade" id="modalEditar">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Editar Tipo Permiso</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="100" class="form-control" id="tipopermiso-editar"
                                               autocomplete="off">
                                    </div>
...
@section('js')
    ...
    <script>
        $(function () {
            const ruta = "{{ url('/admin/tipopermiso/tabla') }}";
    ...
    <script>
        ...
        function recargar() {
            var ruta = "{{ url('/admin/tipopermiso/tabla') }}";
        ...
        function nuevo() {
            var nombre = document.getElementById('tipopermiso-nuevo').value;
            ...
            axios.post(urlAdmin + '/admin/tipopermiso/nuevo', formData, {})
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id) {
            ...
            axios.post(urlAdmin + '/admin/tipopermiso/informacion', {
                'id': id
            })
                .then((response) => {
                    closeLoading();
                    if (response.data.success === 1) {
                        ...
                        $('#id-editar').val(id);
                        $('#tipopermiso-editar').val(response.data.info.nombre);
        ...
        function editar() {
            ...
            var nombre = document.getElementById('tipopermiso-editar').value;
            ...
            axios.post(urlAdmin + '/admin/tipopermiso/editar', formData, {})
                .then((response) => {
                    closeLoading();
