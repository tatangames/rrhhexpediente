...
@section('title', 'Tipo incapacidad')

@section('content_header')
    <h1>Tipo incapacidad</h1>
@stop
...
@section('content')
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <button type="button"
                    ...
                    Nuevo Tipo incapacidad
                </button>
            </div>

            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Tipo incapacidad</li>
                    <li class="breadcrumb-item active">Listado de Tipo incapacidad</li>
                </ol>
            </div>
        </div>
    </section>
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Nuevo Tipo incapacidad</h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="100" class="form-control" id="incapacidad-nuevo"
                                               autocomplete="off">
                                    </div>
    ...
    <div class="modal fade" id="modalEditar">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Editar Tipo incapacidad</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Tipo incapacidad</label>
                                        <input type="text" maxlength="100" class="form-control" id="incapacidad-editar"
                                               autocomplete="off">
                                    </div>
...
@section('js')
    ...
    <script>
        $(function () {
            const ruta = "{{ url('/admin/tipoincapacidad/tabla') }}";
    ...
    <script>
        ...
        function recargar() {
            var ruta = "{{ url('/admin/tipoincapacidad/tabla') }}";
        ...
        function nuevo() {
            var nombre = document.getElementById('incapacidad-nuevo').value;
            ...
            axios.post(urlAdmin + '/admin/tipoincapacidad/nuevo', formData, {})
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id) {
            ...
            axios.post(urlAdmin + '/admin/tipoincapacidad/informacion', {
                'id': id
            })
                .then((response) => {
                    closeLoading();
                    if (response.data.success === 1) {
                        ...
                        $('#id-editar').val(id);
                        $('#incapacidad-editar').val(response.data.info.nombre);
        ...
        function editar() {
            ...
            var nombre = document.getElementById('incapacidad-editar').value;
            ...
            axios.post(urlAdmin + '/admin/tipoincapacidad/editar', formData, {})
                .then((response) => {
                    closeLoading();
