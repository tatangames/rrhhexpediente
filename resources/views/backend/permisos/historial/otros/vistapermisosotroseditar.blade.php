...
@section('js')
    ...
    <script>
        $(function () {
            ...
            // Recarga respetando los filtros actuales activos
            ...
            function mostrarBadgesFiltros(params) {
                ...
                if (params.condicion !== '') {
                    const label = params.condicion == '1' ? 'Fraccionado' : 'Completo';
            ...
            $(document).on('keyup', '#filtro-buscar-empleado', function () {
                ...
                // Debounce para no disparar cada tecla
            ...
            $(document).on('click', '.filtro-empleado-item', function () {
                ...
                $('#filtro-empleado-id').val(id);
                $('#filtro-buscar-empleado').val(nombre);
                $('#filtro-limpiar-empleado').show();
                $('#filtro-lista-empleados').hide();
            });

            // Limpiar selección de empleado con la X
            ...
            // Permitir aplicar filtro con Enter desde el input de empleado
            ...
            axios.post(urlAdmin + '/admin/historial/otros/actualizar', formData)
                .then((response) => {
                    ...
                    if (response.data.success === 1) {
                        ...
                        recargar(); // mantiene los filtros activos
                    } else {
        ...
        // Agrega esta función auxiliar ANTES de mostrarBadgesFiltros
