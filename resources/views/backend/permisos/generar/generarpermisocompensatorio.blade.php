    ...
    <script>
        ...
        $(function () {
                                            ...
                                            ${item.horas_texto ? `
                                                <div class="mt-1">
                                                    <span class="badge badge-info">
                                                        <i class="fas fa-clock"></i> Total: ${item.horas_texto}
                                                    </span>
                                                </div>
                                            ` : ''}
                                        ` : ''}
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div class="flex-grow-1">
                                                <div><strong><i class="fas fa-calendar"></i> Fecha:</strong> ${item.fecha || 'N/A'}</div>
                                                <div class="mt-1"><strong><i class="fas fa-comment"></i> Razón:</strong> ${item.razon || 'Sin descripción'}</div>
                                                ${tiempoHtml}
                                            </div>
                                        </div>
                                    </li>
            ...
            $(document).on('click', '#btn-forzar-guardado', function () {
                ...
                axios.post(urlAdmin + '/admin/guardar/permiso/compensatorio', payload)
                    .then(resp => {
